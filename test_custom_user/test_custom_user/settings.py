"""
Django settings for test_custom_user project.
...
SECRET_KEY = 'f)l4f@$8$3y4nsh7t^ynrk&c3l6$y&j(aw*p$@6(eod#n$dnd9'
...
ROOT_URLCONF = 'test_custom_user.urls'
...
WSGI_APPLICATION = 'test_custom_user.wsgi.application'
...
CKL_REST_AUTH = {
    ...
    'REGISTER_FIELDS': ('email', 'full_name'),
    # Google settings
    'GOOGLE': {
